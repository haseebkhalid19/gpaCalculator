        ...
        <div class="container py-4">
            <div class="row" style="background-color: #fff;">
                                ...
                                <div class="row form_field_outer_row py-3">
                                    ...
                                    <div class="form-group col-md-2 py-2">
                                        <input type="number" class="form-control" id="maxMarks1" name="maxMarks"
                                            placeholder="Max Marks" value="{{ old('maxMarks') }}">
                                        <span class="text-danger">
                                            @error('maxMarks')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group col-md-2 py-2">
                                        <input type="number" class="form-control" id="marksObtained1" name="marksObtained"
                                            placeholder="Marks Obtained" value="{{ old('marksObtained') }}">
                                        <span class="text-danger">
                                            @error('marksObtained')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group col-md-2 py-2">
                                        <input type="number" step="any" class="form-control" id="gradePoints1"
                                            name="gradePoints" placeholder="Grade Points" value="{{ old('gradePoints') }}">
                                        <span class="text-danger">
                                            @error('gradePoints')
                                                {{ $message }}
                                            @enderror
                ...
                <div class="row ml-0 bg-light ms-0 border py-3">
                    <div class="col-md-12">
                        <button name="calculate" class="btn btn-primary py-2" id="add_btn"><i
                                class="fas fa-calculator pe-2"></i>Calculate</button>
                    </div>
                    </form>
                </div>
            </div>
